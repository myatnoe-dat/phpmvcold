...
abstract class RequestsTest_Transport_Base extends PHPUnit_Framework_TestCase {
	...
	public function testExpiredHTTPS() {
		...
		$request = Requests::get('https://testssl-expire.disig.sk/index.en.php', array(), $this->getOptions());
	}
	...
	public function testRevokedHTTPS() {
		...
		$request = Requests::get('https://testssl-revoked.disig.sk/index.en.php', array(), $this->getOptions());
	}
